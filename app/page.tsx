...
export default function HomePage() {
  ...
  const getBulkInquiryLink = () => {
    const text = `Hello Akshita Tote Bags,\n\nI want to enquire regarding wholesale/bulk tote bag orders.\n\nPlease share catalogue and pricing.`;
    return `https://wa.me/919376445844?text=${encodeURIComponent(text)}`;
  };
  ...
  // Extract categories
  const categories = ["All", "Personalized Tote Bags", "Floral Embroidery", "Luxury Tote Bags", "Premium Canvas Bags", "Custom Name Bags"];

  // Featured bags for hero / callouts
  const heroFeaturedBag = products[0]; // Akshita Custom Name Embroidered Tote
  const promoFeaturedBag = products[1]; // Botanical Bloom Handcrafted Tote
    ...
    <div className="relative min-h-screen bg-cream-bg text-charcoal selection:bg-maroon-primary selection:text-white overflow-x-hidden">
      ...
      <div className="bg-maroon-dark text-white/95 text-[10px] sm:text-xs tracking-[0.2em] font-sans font-medium uppercase py-2.5 px-4 text-center border-b border-gold-accent/20 relative z-50 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-3 w-24 justify-end text-white/80">
          <a href="https://instagram.com/akshitatotebags" target="_blank" rel="noopener noreferrer" className="hover:text-gold-accent transition-colors"><FaInstagram className="w-3.5 h-3.5" /></a>
          <a href="https://wa.me/919376445844" className="hover:text-gold-accent transition-colors"><FaWhatsapp className="w-3.5 h-3.5" /></a>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-charcoal/80 max-w-xl font-sans leading-relaxed">
              Premium handcrafted custom tote bags designed with precision for every occasion. Experience the touch of luxurious embroidery, personalized detailing, and durable craftsmanship.
            </p>
          ...
          >
            ...
            >
              ...
              <div className="font-serif text-lg sm:text-xl font-bold text-white">₹600/-</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 bg-maroon-primary text-white border border-gold-accent/20 rounded-3xl p-6 sm:p-10 flex flex-col justify-between shadow-xl relative overflow-hidden">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-gold-accent font-sans font-medium uppercase tracking-wider">
                    Limited Stock
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-white/10">
                    <span className="font-serif text-base sm:text-lg font-medium text-white/90">1 Bag</span>
                    <span className="font-serif text-xl sm:text-2xl font-bold text-gold-accent">₹600</span>
                  </div>
                  
                  {/* Tier 2 */}
                  <div className="flex justify-between items-center py-3 border-b border-white/10">
                    <span className="font-serif text-base sm:text-lg font-medium text-white/90">2 Bags</span>
                    <span className="font-serif text-xl sm:text-2xl font-bold text-gold-accent">₹1000</span>
                  </div>
                  
                  {/* Tier 3 */}
                  <div className="flex justify-between items-center py-3">
                    <div className="flex flex-col">
                      <span className="font-serif text-base sm:text-lg font-medium text-white/90">Buy 2 Get 1 Free</span>
                    ...
                    <span className="font-serif text-xl sm:text-2xl font-bold text-gold-accent">Special Offer</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
                <div className="flex flex-col text-left space-y-1">
                  <span className="text-gold-accent font-serif text-xs font-bold">• Mix & Match Any Designs</span>
                  <span className="text-white/80 font-sans text-xs">• Premium Embroidery</span>
                </div>
                <a
                  href="https://wa.me/919376445844?text=Hello%20Akshita%20Tote%20Bags%2C%20I%20want%20to%20avail%20the%20Premium%20Offer%20(1%20Bag%20%E2%82%B9600%20%7C%202%20Bags%20%E2%82%B91000%20%7C%20Buy%202%20Get%201%20Free)."
                  target="_blank"
            ...
            <div className="lg:col-span-5 bg-cream-bg border border-gold-accent/20 rounded-3xl p-6 sm:p-10 flex flex-col justify-center gap-6 shadow-md">
              ...
              <div className="bg-gold-accent/5 border border-gold-accent/15 rounded-2xl p-4 flex gap-3.5 items-start">
                ...
                <div>
                  <h4 className="font-serif text-xs font-bold uppercase tracking-wider text-maroon-primary mb-1">Buy 2 Get 1 Free</h4>
                  <p className="text-xs text-charcoal/80 font-sans leading-relaxed">
                    Add any 3 tote bags to your inquiry, and pay only for 2! Get 1 bag free under our premium offer.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {filteredProducts.length === 0 && (
            <div className="text-center py-16 text-white/60 flex flex-col items-center gap-3">
              ...
              <p className="font-sans text-sm">No premium tote bags match your search query.</p>
              <button 
          ...
          <div className="bg-cream-card border border-gold-accent/15 rounded-3xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 shadow-xl hover:shadow-2xl transition-shadow duration-500">
            ...
            <div className="relative min-h-[300px] lg:min-h-full aspect-[4/3] lg:aspect-auto overflow-hidden">
              <Image
                ...
                alt="Akshita Premium Handcrafted Tote Detail"
                fill
                loading="lazy"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col gap-3 p-4 bg-cream-card border border-gold-accent/5 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-xs text-charcoal/70 leading-relaxed font-sans">
                Best quality canvas fabrics, embroidery threads, and durable handles.
              </p>
            </div>
          ...
          <div className="text-center mt-12">
            <a
              href="https://wa.me/919376445844?text=Hello%20Akshita%20Tote%20Bags%2C%20I%20am%20interested%20in%20ordering%20premium%20handcrafted%20tote%20bags."
              target="_blank"
              rel="noopener noreferrer"
            ...
            {galleryImages.map((src, index) => (
              ...
              >
                <div className="relative rounded-xl overflow-hidden aspect-[3/4]">
                  <Image
                    src={src}
                    alt={`Akshita Tote Bag Premium Design Showcase ${index + 1}`}
                    fill
                    loading="lazy"
                    className="object-cover transition-transform duration-700 group-hover:scale-105"
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <div className="text-charcoal/80 text-sm font-sans leading-relaxed space-y-4">
              <p>
                Welcome to <strong>Akshita Tote Bags</strong>, your premier destination for <strong>premium handcrafted tote bags</strong>, <strong>personalized embroidery</strong>, and bespoke fashion accessories in New Delhi.
              </p>
              <p>
                Our collections showcase a wide variety of stylish carryalls featuring <strong>custom name bags</strong>, intricate <strong>floral embroidery</strong>, and luxury canvas creations. Every piece is built with high quality craftsmanship using durable premium materials, making them perfect for everyday elegance as well as <strong>perfect for gifting</strong>.
              </p>
              <p>
                Trusted quality, fine finishing details, and seamless shopping support directly through WhatsApp make us New Delhi&apos;s leading choice for personalized tote creations.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-[450px] aspect-[4/3] rounded-3xl overflow-hidden shadow-xl border border-gold-accent/25">
              <Image
                ...
                alt="Akshita Tote Bags Crafting and Heritage"
                fill
                loading="lazy"
                className="object-cover"
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white text-center">
                ...
                <p className="font-serif text-sm font-medium mt-1">Premium Handcrafted Tote Creators</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="bulk" className="bg-maroon-primary py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-6 relative z-10">
          ...
          <p className="text-white/80 text-sm font-sans max-w-xl leading-relaxed">
            Are you a boutique store owner, reseller, or corporate gifting manager? Akshita Tote Bags accepts custom bulk orders and ships wholesale consignments across India. Enquire now for custom quotes and pricing catalog.
          </p>
          <div className="pt-2">
            <a
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-5 bg-cream-card border border-gold-accent/15 rounded-3xl p-8 sm:p-10 flex flex-col justify-between shadow-md">
              <div className="flex flex-col gap-6">
                <h3 className="font-serif text-xl font-bold text-maroon-primary">AKSHITA TOTE BAGS</h3>
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-charcoal/80 font-sans leading-relaxed">
                        Select Citywalk Mall, The New Delhi Dome, 5th & 6th Floor, Saket District Centre, New Delhi, Delhi, India
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <a href="tel:+919376445844" className="text-xs text-charcoal/80 hover:text-maroon-primary transition-colors font-sans block">
                        +91 93764 45844
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <a href="https://instagram.com/akshitatotebags" target="_blank" rel="noopener noreferrer" className="text-xs text-charcoal/80 hover:text-maroon-primary transition-colors font-sans block font-medium">
                        @akshitatotebags
                      </a>
                    </div>
                  </div>
              ...
              <div className="flex flex-col gap-3 mt-8">
                <a
                  href="https://wa.me/919376445844?text=Hello%20Akshita%20Tote%20Bags%2C%20I%20would%20like%20to%20visit%20your%20store."
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://instagram.com/akshitatotebags"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="lg:col-span-7 relative min-h-[350px] lg:min-h-full bg-cream-card rounded-3xl overflow-hidden shadow-md border border-gold-accent/15 flex flex-col">
              <div className="flex-grow relative">
                <iframe
                  title="Akshita Tote Bags Location Map"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3504.858739981881!2d77.21634597607738!3d28.528956975720977!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce1f705357dd5%3A0xe543b59373e7d41f!2sSelect%20CITYWALK%2C%20Saket%2C%20New%20Delhi!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
              ...
              <div className="bg-cream-accent/40 px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-3 border-t border-gold-accent/10">
                ...
                <a
                  href="https://maps.google.com/?q=Select+Citywalk+Mall,+Saket+District+Centre,+New+Delhi"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          >
            ...
            >
              <Image
                ...
                alt="Selected premium tote bag image full screen details"
                fill
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Akshita Tote Bags",
            "image": [
              "https://akshitatotebags.com/assets/bag-1.jpeg"
            ],
            "telephone": "+919376445844",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Select Citywalk Mall, The New Delhi Dome, 5th & 6th Floor, Saket District Centre",
            ...
            "sameAs": [
              "https://instagram.com/akshitatotebags"
            ],
            "priceRange": "$$"
          })
        }}
