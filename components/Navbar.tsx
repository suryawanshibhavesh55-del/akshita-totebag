        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              ...
              className="flex items-center gap-1.5 text-white/90 hover:text-gold-accent transition-colors duration-300 text-xs tracking-wider font-sans"
            >
              <Phone className="w-3.5 h-3.5 text-gold-accent" />
              <span>+91 93764 45844</span>
            </a>
          </div>
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-3">
              ...
              <div className="pt-4 flex flex-col gap-3">
                ...
                <a
                  href="https://wa.me/919376445844?text=Hello%20Akshita%20Tote%20Bags%2C%20I%20would%20like%20to%20enquire%20about%20your%20bags."
                  target="_blank"
